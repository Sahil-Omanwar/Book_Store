...
const About = () => {
  return (
    <div className="relative bg-gradient-to-r from-blue-200 via-blue-300 to-blue-400 p-5 min-h-screen flex items-center justify-center">
      <div className="absolute inset-0 bg-black opacity-50"></div>
      <div className="relative z-10 max-w-4xl mx-auto text-white p-6 sm:p-8 bg-blue-900 bg-opacity-75 rounded-lg shadow-lg">
        <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-center">About Our Bookstore</h1>
