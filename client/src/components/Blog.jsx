...
const Blog = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-200 via-blue-300 to-blue-400 p-4 sm:p-6 md:p-10 min-h-screen">
      {selectedPost ? (
        <div className="max-w-4xl mx-auto bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-lg">
          <h1 className="text-3xl sm:text-4xl font-bold text-blue-900 mb-4">{selectedPost.title}</h1>
        ...
        <>
          <div className="text-center mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold text-blue-900"></h1>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.map(post => (
              <div key={post.id} className="bg-white p-4 sm:p-6 rounded-lg shadow-lg cursor-pointer" onClick={() => handlePostClick(post)}>
                <h2 className="text-xl sm:text-2xl font-bold text-blue-900 mb-2">{post.title}</h2>
